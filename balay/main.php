  ...
  <!-- Facebook and Twitter integration -->
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
			<h1 id="colorlib-logo"><a href="index.html">MORSHID</a></h1>
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					<li class="colorlib-active"><a href="main.php">Home</a></li>
					<li><a href="http://localhost/sc/#0">Schedule</a></li>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved to Morshid
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --> </span> 
		...
		<aside id="colorlib-hero" class="js-fullheight">
				<div class="flexslider js-fullheight">
					<ul class="slides">
				   	<li >
							<iframe src="https://www.google.com/maps/d/embed?mid=1OyBUtV6wJcDiGirjOjkUKXejHot30zMw" width="100%" height="780"></iframe>
