  ...
  <!-- Facebook and Twitter integration -->
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
			<h1 id="colorlib-logo"><a href="index.html">MORSHED</a></h1>
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					<li class="colorlib-active"><a href="main.php">Home</a></li>
					<li><a href="work.html">Schedule</a></li>
					<li><a href="form.html">Piligrim Data</a></li>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved to Morshed
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --> </span> 
		...
		<aside id="colorlib-hero" class="js-fullheight">
				<div class="flexslider js-fullheight">
					<ul class="slides">
				   	<li >
							<iframe src="https://www.google.com/maps/d/embed?mid=1SA3I4eAKhNlzKYuvJAYlu2jPY4Ej5QcT" width="100%" height="780"></iframe>
				   			...
				   			<div class="row">
					   			<div class="col-md-6 col-md-offset-3 col-md-push-3 col-sm-12 col-xs-12 js-fullheight slider-text">
					   				<div class="slider-text-inner">
					   					<div class="desc">
						   					<h1>Crowd is no longer a problem</h1>
						   					<h2>Please no worries if you get lost we will get you back to your group <a href="https://colorlib.com/" target="_blank">colorlib.com</a></h2>
